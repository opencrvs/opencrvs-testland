...
export const roles: Role[] = [
  ...
  },
  {
    ...
    scopes: defineScopes([
      ...
      { type: 'user.read' },
      { type: 'user.search' },
      { type: 'record.search', options: { flags: { noneOf: ['sealed'] } } },
      ...
      { type: 'record.read', options: { flags: { noneOf: ['sealed'] } } },
      { type: 'record.declare' },
      { type: 'record.reject' },
      { type: 'record.archive' },
  ...
  },
  {
    ...
    scopes: defineScopes([
      { type: 'user.read-only-my-audit' },
      { type: 'record.search', options: { placeOfEvent: 'location', event: ['death'], flags: { noneOf: ['sealed'] } } },
      { type: 'workqueue', options: { ids: ['assigned-to-you', 'recent', 'ready-for-attestation'] } },
      { type: 'record.read', options: { placeOfEvent: 'location', event: ['death'], flags: { noneOf: ['sealed'] } } },
